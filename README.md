...
##
the core of this research utilizes a Seq2Seq objective. to maintain high transcriptive integrity, the loss function is computed by explicitly masking padding tokens. this ensures that the model optimization is driven exclusively by the relevant phonetic and lexical content of the police radio transmissions.

...
if __name__ == "__main__":
    ...
    parser.add_argument("--pl_col", default="pseudo_label")
    parser.add_argument("--gold_col", default="ground_truth")
    ...
    print(f"\noriginal wer:                 {orig_overall_wer:.4f}")
    print(f"normalized wer:               {norm_overall_wer:.4f}\n")
